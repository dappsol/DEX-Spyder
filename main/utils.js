...
function aff_main_menu() {
    console.log(chalk_1.default.white('\t[1] - Token Sniping Mode'));
    console.log(chalk_1.default.white('\t[2] - Pool Sniping Mode'));
    console.log(chalk_1.default.white('\t[3] - Sniping All USDC Pool Mode'));
    console.log(chalk_1.default.white('\t[4] - Settings'));
    console.log(chalk_1.default.white('\t[5] - Exit'));
    console.log("\n");
}
exports.aff_main_menu = aff_main_menu;
function aff_sniper_menu() {
    console.log(chalk_1.default.blueBright('\t[1] - Snipe (buy)'));
    console.log(chalk_1.default.greenBright('\t[2] - Exit Position (Sell)'));
